  ...
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        If you are intrested in our Newsletter Please Enter your NAME and EMAIL to get monthly updates from Blue Design Studio
      </p>
      <form>
        <input
          type="text"
        ...
        <p className="text-center text-base font-medium leading-relaxed text-body-color">
          Note: If you wish to opt-out of this later you have to contact BlueDesignStudio. Due to higher work your request my be delayed.
        </p>
      </form>
