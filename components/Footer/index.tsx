            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    href="https://www.instagram.com/_blue.design.studio_/"
                  ...
                  <a
                    href="https://www.youtube.com/watch?v=UtXPfW1hEho"
                    aria-label="social-link"
                    className="mr-6 text-[#CED3F6] hover:text-primary"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.linkedin.com/company/blue-design-studio/"
                    aria-label="social-link"
                    className="mr-6 text-[#CED3F6] hover:text-primary"
                  >
                    <svg
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              Created and maintained by <a href="https://nexactlysolutions.com/" rel="nofollow noopener">Nexactly Solutions</a>
            </p>
          </div>
        </div>
